...
public class EmailUtils {
    ...
    private static final String EMAIL_USERNAME = "huynhnguyen7325@gmail.com";
    private static final String EMAIL_PASSWORD = "ulzf wqsg wprt aayi";
    ...
    private static String createRegistrationEmailContent(String fullName, String userID) {
        return "<!DOCTYPE html>\n"
                ...
                + "            <a href=\"http://localhost:8080/YUGIOH_SHOP_PROJECT/login.jsp\" class=\"button\">Login to Your Account</a>\n"
                + "            <p>If you have any questions or need assistance, please don't hesitate to contact our support team.</p>\n"
                + "            <p>Best regards,<br>TCG YUGIOH SHOP PROJECT PRJ301_SE1931</p>\n"
                + "        </div>\n"
                + "        <div class=\"footer\">\n"
